...
SCENARIOS = {
    ...
    "classic": {
     ...
     # New scenario: treasure-hunt
    "treasure-hunt": {
        "CRATE_DENSITY": 0.4,  # Moderate crate density
        "COIN_COUNT": 30        # Higher coin count
    },
    
    # New scenario: bomb-dungeon
    "bomb-dungeon": {
        "CRATE_DENSITY": 0.9,  # Very high crate density
        "COIN_COUNT": 5,       # Low coin count
        # You could add more parameters like bomb frequency if needed
    }
...
ASSET_DIR = Path("C:/Users/veena/Downloads/bomberman_rl-master/bomberman_rl-master/assets")
